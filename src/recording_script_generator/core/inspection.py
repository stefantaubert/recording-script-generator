...
def remove_utterances_with_acronyms_inplace(representations: Representations, selection: Selection, min_acronym_len: int, n_jobs: int, chunksize: int, maxtasksperchild: Optional[int]) -> Set[UtteranceId]:
...
def remove_utterances_with_unfrequent_words(representations: Representations, selection: Selection, min_occurrence_count: int, n_jobs: int, chunksize: int, maxtasksperchild: Optional[int]) -> Set[UtteranceId]:
...
def remove_utterances_with_proper_names(representations: Representations, selection: Selection, n_jobs: int, chunksize: int, maxtasksperchild: Optional[int]) -> Set[UtteranceId]:
...
def remove_utterances_with_undesired_text(representations: Representations, selection: Selection, undesired: Set[str], n_jobs: int, chunksize: int, maxtasksperchild: Optional[int]) -> Set[UtteranceId]:
...
def remove_utterances_with_custom_word_counts(representations: Representations, selection: Selection, min_count: Optional[int], max_count: Optional[int], n_jobs: int, chunksize: int, maxtasksperchild: Optional[int]) -> Set[UtteranceId]:
...
def remove_utterances_with_non_dictionary_words(representations: Representations, selection: Selection, max_unknown_word_count: int, n_jobs: int, chunksize: int, maxtasksperchild: Optional[int]) -> Set[UtteranceId]:
